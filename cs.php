<table class="table-responsive border_table" >
    <tbody>
                 ...
                 <p>Name & Status Of CEO :</p>
                
                            <div class="form-group">
                                 <b>Fullname :<input type="text" placeholder="Enter Your Fullname"  name="fullname" maxlength="46" required="required"> </b>          
                                 <b style="margin-left: 10%;">Position :  <input type="text" placeholder="Position" name="age"required="required"></b>
  </div>
  ...
  <select name="sex" required="required">
      ...
      <option value="Female">Female</option>
       ...
       <b style="margin-left: 25%;">Companies Years Of Expriance: <input type="text" placeholder="Experiance" name="dob" maxlength="46" height="30%" required="required"></b>
                            </div>
                            ...
                            <div class="form-group">
                                <b>   Focus Area</b>
																				...
																				<option value="Education">Textile & Leather</option>
																				<option value="Health System & Social work">Health System & Social work</option>
																				<option value="Finance & Banking">Finance & Banking</option>
																				<option value="Maintenance Service">Maintenance Service</option>
																				<option value="Public & Buisness Adminstartion">Public & Buisness Adminstartion</option>
																				<option value="Mechanical Trades">Mechanical Trades</option>
																				<option value="Hair Cutting, Beautician">Hair Cutting, Beautician</option>
                            ...
                            <div class="form-group">
                                <b>  Are you presently??:</b>
                                                                                        ...
                                                                                        <input name="estatus" type="radio" value = "Employing" maxlength="46" required><b>Employing</b>
                                                                                        <input name="estatus" type="radio" value = "Not Emloying" maxlength="46" required><b>Not Employing</b>
