...
<body>
  ...
  <div class="top_banner">
    <div class="in_banner">
          ...
          <img alt="" src="../admin//Shashemene.jpg" class="img-responsive img-thumbnail" width="90" style="margin-top: 2%;">
   ...
   <div class="middle" style="margin-left:30%;">
        <button style="background-color: lightblue;">
            <a href="homead.php"style="color:black;" ><i class="fas fa-home"></i>HOME </a>
             ...
             <button style="background-color: lightblue;">
            <a href="sexit.php"style="color:black;"><i class="fas fa-users"></i> GENDER_Gr </a>
        </button>
        
            <button style="background-color: lightblue;">
                <a href="sexcs.php"style="color:black;" ><i class="fas fa-job"> </i> GENDER_CEO</a>
            </button>
