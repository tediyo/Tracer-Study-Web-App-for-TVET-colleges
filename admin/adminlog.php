...
<body style="background:White;" >
  ...
  <div class="top_banner"style="background:purple;">
    <div class="in_banner">
            <div class=" logo">
    ...
    <div class="cleaner">
        ...
        <h2 id="lbltitle" style="font-weight:bold; width: 25%; background-color: Blue; text-align: center;">
          Admin Login form
        </h2>
            <div class="mid-outer">
                <div class="mid-inner">
            ...
            <div>
            <center>
         <footer style="position: absolute; bottom: 0; width: 50%; text-align: center;font-weight: bold;">
