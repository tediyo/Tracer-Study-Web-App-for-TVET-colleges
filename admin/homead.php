    ...
    ?>
     <script type="text/javascript">
      ...
      function drawChart() {
        ...
        var options = {
          title: 'GRADUATES BY EMPLOYABILITY STATUS'
        };
...
<div>
    ...
    ?>
      ...
      function drawChart() {
        ...
        var options = {
          title: ' EMPLOYERS BY EMPLOYABILITY STATUS',
           is3D: true,
        };
...
<div>
    ...
    ?>
      ...
      function drawChart() {
        ...
        var options = {
          title: 'GRADUATES BY JOB LOCATION'
        };
...
<div>
    <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
     <?php
    $query = "SELECT region, count(*) as number FROM bsitgrad GROUP BY region";
...
<div>
    <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
     <?php
    $cs = "SELECT religion, count(*) as number FROM bsitgrad GROUP BY religion";
...
<div>
    ...
    ?>
      ...
      function drawChart() {
        ...
        var options = {
          title: ' GRADUATES BY Job SITUATION',
...
<!-- <div>
    ...
    ?>
      ...
      function drawChart() {
        ...
        var options = {
          title: 'EMPLOYERS BY JOB Situation',
          is3D: true,
        };
...
<div>
  ...
  <div class="top_banner" style="background-color:purple;" >
    <div class="in_banner">
            <div class="logo">
            <img alt="" src="../admin/image//banner.png"  width="190" height="80" style="margin-top: 22%;"></div> 
                <img alt="" src="../admin/image//BPTC.jpg" class="img-responsive img-thumbnail" width="90" style="margin-top: 2%;">
      <div class="banner_text">
      <h1 style="color: greenyellow;">
                  Bahir Dar Polytechnic collage
          </h1>
              <h2 style="color: gold;">
        ...
        <button class="btn btn-dark">
            <a href="admin_it.php"style="color:skyblue;"><i class="fas fa-users"></i>Graduate</a>
        </button>
        
            <button class="btn btn-dark">
                <a href="admin_cs.php"style="color:skyblue;" ><i class="fas fa-users"> </i>Employer</a>
            </button>
    ...
    <div class="cleaner">
              ...
              <div class="muted pull-left"><i class="icon-time"></i>&nbsp;<?php include('time.php'); ?></div>      
                 <br>
                  ...
                  <table>
                      <td>
                          <h5  style="width:500px; margin-left: 30%; background-color:skyblue; text-align: center;"> GRADUATE TOTAL RESPONSES: <?php
                                          ...
                                          <td class="" align="right">
                                                 <h5  style="width:500px; text-align: center; margin-left: 35%; background-color:skyblue;"> EMPLOYER TOTAL RESPONSES : <?php
                 ...
                 <div id="chart_loc" style="width:500px; height: 250px; margin-left: 30%; background-color:#cacaca;">  
                     ...
                     <button>
                                          ...
                                          <!--<td class="">
                                                 ...
                                                 <div id="chart_loc" style="width:500px; height: 50px; margin-middle: 30%; background-color:#F11212;">  
                                                 </div>    <div style="width:500px; height: 30px; margin-left: 30%; background-color:skyblue; font-family: bold;  text-align: center;"><button>  Total work in:    <?php
                                                                               $itlocal = "SELECT COUNT(*)AS count FROM bsitgrad WHERE location = 'local'";
                                                                               $it_local = mysqli_query($conn, $itlocal);
                                             ...
                                             <td class="" align="right">
                 <div id="locchart" style="width:500px; height: 250px; margin-left: 35%; background-color:#F8E7E8;"> 
                 </div>  <div style="width:500px; height: 30px; margin-left: 35%; background-color:skyblue; font-family: bold;  text-align: center; "> <button>
                                         Total work in:  <?php
                                               $ab= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region= 'Hotel tourism'";
                                               $ab_count = mysqli_query($conn, $ab);
                             
                                               while ($row = mysqli_fetch_assoc($ab_count)){
                                                   echo "Hotel tourism :" .$row ['count'];
                                                   }?></button>
                          <button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Garment Technology'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Garment Technology :" .$row ['count'];
                                                   }?></button>

<button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Electricity_electronics'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Electricity_electronics :" .$row ['count'];
                                                   }?></button>
                                                   
                                              
                                                   <button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Metal manufacturing'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Metal manufacturing :" .$row ['count'];
                                                   }?></button>
                                                   <button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Wood work'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Wood work :" .$row ['count'];
                                                   }?></button>
                                                   <button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'ICT'";
                                               $loc_count = mysqli_query($conn, $loc);
                                               ...
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   ...
                                                   <button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Agriculture'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Agriculture :" .$row ['count'];
                                                   }?></button>

<button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Water and irrigation technology'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Water and irrigation technology :" .$row ['count'];
                                                   }?></button>
                                                   <button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Surveying, Drafting & Urban land'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Surveying, Drafting & Urban land :" .$row ['count'];
                                                   }?></button>
                                                   <button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Textile technology'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Textile technology :" .$row ['count'];
                                                   }?></button>
                                                   <button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Building Construction'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Building Construction :" .$row ['count'];
                                                   }?></button>
                                                   <button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Road Construction'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Road Construction :" .$row ['count'];
                                                   }?></button>
                                                   <button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Muncipality services'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Muncipality services :" .$row ['count'];
                                                   }?></button>
                                                   <button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Automotive technology'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Automotive technology :" .$row ['count'];
                                                   }?></button>
                                                   <button>
                                           <?php
                                               $loc= "SELECT COUNT(*)AS count FROM bsitgrad WHERE region = 'Other'";
                                               $loc_count = mysqli_query($conn, $loc);
                             
                                               while ($row = mysqli_fetch_assoc($loc_count)){
                                                   echo " Other :" .$row ['count'];
                                                   }?></button>
              </div>
                 ...
                 <div id="chart" style="width:500px; height: 250px; margin-left: 35%; background-color:#cacaca;"> 
                                               ...
                                               $csmale = "SELECT COUNT(*)AS count FROM bsitgrad WHERE religion = 'Level 1'";
                                               $csmale_result = mysqli_query($conn, $csmale);
                             
                                               while ($r = mysqli_fetch_assoc($csmale_result)){
                                                   echo " Level 1 :" .$r ['count'];
                                               }
                                               ?> </button>
                     <button>
                                           <?php
                                               $csfemale= "SELECT COUNT(*)AS count FROM bsitgrad WHERE religion = 'Level 2'";
                                               $csfemale_count = mysqli_query($conn, $csfemale);
                             
                                               while ($r = mysqli_fetch_assoc($csfemale_count)){
                                                   echo " Level 2 :" .$r ['count'];
                                                   }?></button>
                          <button>
                                           <?php
                                               $othersex= "SELECT COUNT(*)AS count FROM bsitgrad WHERE religion = 'Level 3'";
                                               $othersex_count = mysqli_query($conn, $othersex);
                             
                                               while ($r = mysqli_fetch_assoc($othersex_count)){
                                                   echo " Level 3 :" .$r ['count'];
                                                   }?></button>
                                                   <button>
                                           <?php
                                               $othersex= "SELECT COUNT(*)AS count FROM bsitgrad WHERE religion = 'Level 4'";
                                               $othersex_count = mysqli_query($conn, $othersex);
                             
                                               while ($r = mysqli_fetch_assoc($othersex_count)){
                                                   echo " Level 4 :" .$r ['count'];
                                                   }?></button>
                                                   <button>
                                           <?php
                                               $othersex= "SELECT COUNT(*)AS count FROM bsitgrad WHERE religion = 'Level 5'";
                                               $othersex_count = mysqli_query($conn, $othersex);
                             
                                               while ($r = mysqli_fetch_assoc($othersex_count)){
                                                   echo " Level 5 :" .$r ['count'];
                                                   }?></button>
