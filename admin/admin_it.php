  ...
  <div class="top_banner"style="background-color:purple;">
    <div class="in_banner">
            ...
            <img alt="" src="../admin/image//banner.png"  width="190" height="80" style="margin-top: 22%;"></div> 
                <img alt="" src="../admin/image//Shashemene.jpg" class="img-responsive img-thumbnail" width="90" style="margin-top: 2%;">
      <div class="banner_text">
         <h1 style="color: blue;">
          Shashemene Polytechnic collage
          </h1>
              <h2 style="color: gold;">
    ...
    <div class="middle" style="margin-left:25%;">
        ...
        <button class="btn btn-primary">
            <b>  <a href="admin_it.php"style="color:white;"><i class="fas fa-users"></i>Graduates</a></b>
        </button>
        
            <button class="btn btn-dark">
                <b>   <a href="admin_cs.php"style="color:skyblue;" ><i class="fas fa-job"> </i>Employers</a></b>
            </button>
    ...
    <!-- <colgroup>
           ...
           <div>
            <input type="text"  id="search_box" class="form-control" autocomplete="off" placeholder="search....."/></div>
             <div id="searchresult">  
        <h5 style="background: darkgray;color: black; text-align: center;" ><b>GRADUATE LISTS</b></h5>
    ...
    <tr>
      ...
      <th class="text-lg-center"><select name="fetch" id="fetch">
            ...
            <th class="text-lg-center"><select name="fetchval" id="fetchval">
              <option value=""  selected="">Employability Status
       ...
       <th class="text-lg-center">Salary
       </th>
       <th class="text-lg-center">Department
       </th>
       ...
       <th class="text-lg-center">View
       </th>
       <th class="text-lg-center">Delete
       </th>
	...
	?>
     <tr>
        ...
        <td class="text-lg-center">
                                    ...
                                    <td class="text-lg-center">
        <a href="#" class="btn btn-success mr-3 view_btn" title="View GRADUATE DATA "><i class="fa fa-address-card"></i></a>
     </td>
     <td class="text-lg-center">
