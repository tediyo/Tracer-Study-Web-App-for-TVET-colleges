...
<body>
 ...
 <div class="middle" style="margin-left:25%;">
        ...
        <button class="btn btn-dark">
            <b>  <a href="admin_it.php"style="color:skyblue;"><i class="fas fa-users"></i>GRADUATES</a></b>
        </button>
        
            <button class="btn btn-primary">
                <b>   <a href="admin_cs.php"style="color:white;" ><i class="fas fa-job"> </i>EMPLOYERS</a></b>
            </button>
...
<form>
    ...
    <!-- <colgroup>
           ...
           <input type="text"  id="search_box" class="form-control" autocomplete="off" placeholder="search....."/> 
            ...
            <div id="searchresult">          
        <h5 style="background: black;color: white; text-align: center;" ><b>EMPLOYER LISTS</b></h5>       
    ...
    <tr>
      ...
      <th class="text-lg-center"><select name="fetchval" id="fetchval">
              <option value="" disabled="" selected="">Employability Status</option>
                <option value="Employed">Employing</option>
                <option value="Self-employed">Not Employing</option>
