  ...
  <div class="top_banner"style="background-color:purple;">
    <div class="in_banner">
      ...
      <div class="banner_text">
        ...
        <button class="btn btn-dark">
            <a href="admin_it.php"style="color:skyblue;"><i class="fas fa-users"></i>GRADUATES</a>
        </button>
...
<div>
            <center>
         <footer style="position: absolute; bottom: 0; width: 80%; text-align: center;font-weight: bold;">
        &copy; 2024 - Game Changers Consultung PLC .
    </footer>
    </center>
    </div>
</body>
