...
<body>
  ...
  <div class="top_banner">
    <div class="in_banner">
            <div class=" logo">
                <img alt="" src="../admin/image//banner.png" style="width: 190%"; height="80">
                </div>
    ...
    <div class="middle" style="margin-left:25%;">
        ...
        <button class="btn btn-primary">
            <b>  <a href="admin_it.php"style="color:white;"><i class="fas fa-users"></i>GRADUATE</a></b>
        </button>
        
            <button class="btn btn-dark">
                <b>   <a href="admin_cs.php"style="color:skyblue;" ><i class="fas fa-job"> </i>EMPLOYER</a></b>
            </button>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">GRADUTAE Profile</h5>
